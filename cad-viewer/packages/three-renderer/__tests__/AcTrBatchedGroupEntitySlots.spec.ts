...
describe('AcTrBatchedGroup entity slot records', () => {
  it('keeps a zero-slot entity registered, counted and removable', () => {
    ...
    // No drawable at all: the entity must still be registered (the previous
    // implementation stored an empty array here).
    ...
    // The previous implementation deleted the entry and returned `false`: no
    // slot and no unbatched drawable was ever removed.
