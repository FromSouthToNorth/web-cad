...
export class AcTrBatchedLine2 extends AcTrBatchedLine2Base {
   ...
   * the packed segment buffer directly.
   *
  ...
  /**
   * Aggregate batch-local bounding sphere from one pass over the packed
   ...
   * circumsphere of the aggregate bounds of the same active slot set, so it
